...
static inline int commonFtau(const CeedScalar lambda, const CeedScalar mu,
  ...
  /*
   F_inv[3][3] = {{F_invwork[0], F_invwork[5], F_invwork[4]},
                  {F_invwork[8], F_invwork[1], F_invwork[3]},
                  {F_invwork[7], F_invwork[6], F_invwork[2]}
                  };
 */
  // *INDENT-ON*
 ...
 /*
 tau[0][0] = (*llnj-mu)+mu*b[0][0];
 tau[0][1] = mu*b[0][1]; 
 tau[0][2] = mu*b[0][2]; 
 tau[1][0] = mu*b[1][0]; 
 tau[1][1] = (*llnj-mu)+mu*b[1][1];
 tau[1][2] = mu*b[1][2]; 
 tau[2][0] = mu*b[2][0]; 
 tau[2][1] = mu*b[2][1]; 
 tau[2][2] = (*llnj-mu)+mu*b[2][2];
 
 tau[3][3] = {{(*llnj-mu)+mu*b[0][0], mu*b[0][1], mu*b[0][2]},
               {mu*b[1][0], (*llnj-mu)+mu*b[1][1], mu*b[1][2]},
               {mu*b[2][0], mu*b[2][1], (*llnj-mu)+mu*b[2][2]}
              }; 
  */
